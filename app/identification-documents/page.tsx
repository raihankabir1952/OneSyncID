...
function DocumentCard({
  ...
  return (
    <div className="flex flex-col gap-[10px]">
      ...
      >
        Upload or scan your identification documents using your phone. Accepted
...
export default function IdentificationDocumentsPage() {
  ...
  const [docs, setDocs] = useState<
    { id: number; type: DocType; filename: string }[]
  >([
    {
      id: 1,
      type: "Identity",
  ...
  const handleFileSelect = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setDocs((prev) => [
      ...prev,
      { id: Date.now(), type: "Identity", filename: file.name },
    ]);
    e.target.value = "";
  };
      ...
      <div className="w-full max-w-[393px] bg-white min-h-screen flex flex-col">
        ...
        >
          ...
          <div className="flex flex-col gap-[10px] w-full">
            ...
            >
              Upload or scan your identification documents using your phone.
              Accepted Formats: PDF, JPG, PNG (maximum 5 MB per file)
            </p>
          </div>
