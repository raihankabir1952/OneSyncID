  ...
  return (
    <div className="min-h-screen bg-gray-100 flex justify-center">
      <div className="w-full max-w-[393px] bg-white min-h-screen flex flex-col">
        ...
        {/* Main Content */}
        <div className="flex flex-col justify-between flex-1 px-5 pt-10 pb-8">
          <div className="flex flex-col gap-6">
            <AccountTypeToggle activeType={accountType} onTypeChange={handleTypeChange} />

            {/* Organization Message */}
            {accountType === "organization" && (
              <div className="flex flex-col gap-3">
                <p style={fontSwitzer} className="text-[16px] text-[#333] tracking-[0.16px] text-justify">
                  Want to register your Brand, Business, Education, or NGO/Government?
                </p>
                <p style={fontSwitzer} className="text-[16px] text-[#0052b4] text-justify">
