...
const SECTIONS = [
  {
    ...
    title: "Login History",
    description:
      "See all logins to your organization account, including where, when, and from which device.",
  ...
  },
  {
    ...
    description:
      "View all devices currently signed in to your account, including last activity and location. Sign out of any session you don't recognize.",
  ...
  },
  {
    ...
    description:
      "Add devices you trust to access your account. Only registered devices can log in.",
